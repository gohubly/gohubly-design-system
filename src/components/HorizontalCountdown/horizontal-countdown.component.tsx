...
export const HorizontalCountdown: React.FC<iHorizontalCountdown> = ({
  ...
  const getCountdownColor = (count: number) => {
    ...
    return countdown < count ? theme.colors.primaryLight : theme.colors.primaryMedium
  }
  ...
  const getDescription = () => {
    ...
    if (countdown === 1) return 'Seu período de teste hl. Última chance para gerenciar o pagamento da sua assinatura.'
