...
export default function Svg(props: any) {
  return (
    ...
    >
      ...
      />
      <path
        d="M12.0007 12.8165C13.3814 12.8165 14.5007 11.7179 14.5007 10.3628C14.5007 9.00771 13.3814 7.90918 12.0007 7.90918C10.62 7.90918 9.50073 9.00771 9.50073 10.3628C9.50073 11.7179 10.62 12.8165 12.0007 12.8165Z"
        fill="#425DC7"
        stroke="#425DC7"
        strokeWidth="1.5"
        strokeLinecap="round"
